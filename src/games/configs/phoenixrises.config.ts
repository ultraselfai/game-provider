...
export const PHOENIX_RISES_CONFIG: GameConfig = {
  gameId: 'phoenixrises',
...
export { SYMBOLS as PHOENIX_RISES_SYMBOLS };
export { PAYLINES as PHOENIX_RISES_PAYLINES };
export { PREDEFINED_WINS as PHOENIX_RISES_WINS };
export { PREDEFINED_LOSSES as PHOENIX_RISES_LOSSES };
