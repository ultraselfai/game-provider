...
/**
 * Configuração do Fortune Panda
 * Grid: 3x3, 5 paylines
 * Tema: Ano Novo Chinês com Panda da Fortuna
 */
...
export { SYMBOLS as FORTUNE_PANDA_SYMBOLS };
export { PAYLINES as FORTUNE_PANDA_PAYLINES };
export { PREDEFINED_WINS as FORTUNE_PANDA_WINS };
export { PREDEFINED_LOSSES as FORTUNE_PANDA_LOSSES };
